...
// 5. Marketing Campaign Performance (Radar Chart)
    ...
    new Chart(chartContext, {
        ...
        options: {
            ...
            elements: {
             ...
             scales: { // Radar charts use 'r' for the radial axis
                r: {
                    // Note: For better comparison, consider normalizing data or using logarithmic scale if values differ vastly
                    // beginAtZero: true // Often useful for radar
                }
            },
            plugins: {
                legend: {
